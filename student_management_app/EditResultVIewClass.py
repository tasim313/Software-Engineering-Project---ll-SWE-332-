...
class EditResultViewClass(View):
    def get(self, request, *args, **kwargs):
        ...
        return render(request, "teacher_templates/edit_student_result.html", {"form": edit_result_form})
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            return render(request, "teacher_templates/edit_student_result.html", {"form": form})
