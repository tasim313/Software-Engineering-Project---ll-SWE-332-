...
from .models import Students, Courses, Subjects, CustomUser, Attendance, AttendanceReport, \
...
def student_apply_leave(request):
    ...
    leave_data=LeaveReportStudent.objects.filter(student_id=teacher_obj)
...
def student_feedback(request):
    ...
    feedback_data=FeedBackStudent.objects.filter(student_id=teacher_id)
